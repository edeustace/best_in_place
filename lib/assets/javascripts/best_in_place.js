  ...
  "textarea" : {
   ...
   "file" : {
    activateForm : function() {
      ...
      if( $("#" + uid ).length == 0 )
      {
        $('body').append('<iframe id="'+uid+'" style="visibility:hidden; width: 1px; height: 1px; position: absolute;" name="'+uid+'"></iframe>')
        $('#' + uid ).bind('load', {editor: this, uid: uid}, BestInPlaceEditor.forms.file.iframeLoadHandler );
      }
