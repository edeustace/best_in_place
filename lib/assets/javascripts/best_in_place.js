...
BestInPlaceEditor.prototype = {
  ...
  processImages : function()
  {
    if( this.element.attr('data-type') == 'img')
    {
      ...
      var imageSpan = '<span class="bip_image" data-url="'+ this.url +'" data-original-content="'+imgUrl+'" data-form-name="'+formName+'"></span>';
  ...
  {
    var inplaceImageOptions = { jsonResponseUrlKey: 'display_as', data : {_method: "put" }};
    $(".bip_image").inplaceImageChanger(inplaceImageOptions);
  },
