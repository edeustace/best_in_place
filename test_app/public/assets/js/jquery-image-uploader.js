...
com.ee.InPlaceImageEditor = (function(){
  function InPlaceImageEditor(e, options)
  {
    ...
    console.log("com.ee.InPlaceImageEditor: element: " + this.$element);
    console.log("com.ee.InPlaceImageEditor: options: " + this.options);

    this._createImageTag(this.$element.attr('data-original-content'));
    this._createFileInput();
  }
  return InPlaceImageEditor;
})();
  


com.ee.InPlaceImageEditor.prototype = {
  ...
  buildFormSegment : function(key, value, boundary)
  {
    ...
    return this._buildFormSecment( contentDisposition, value, boundary);
  },
  buildFileFormSegment : function( formName, fileName, binaryData, boundary)
  {
    ...
    return this._buildFormSecment( contentDisposition, binaryData, boundary );
  },
  _buildFormSecment : function( contentDisposition, value, boundary )
  {
    var output = '';
    output += this.dashdash
    output += boundary;
...
jQuery.fn.inplaceImageEditor = function(options) {
  this.each(function(index){
    //console.log( "each.. : " + this + " " + options  + ", " + index);
    if (!jQuery(this).data('com_ee_inplaceImageEditor')) {
      jQuery(this).data('com_ee_inplaceImageEditor', new com.ee.InPlaceImageEditor(this, options));
    }
  });
  return this;
};
